...
import svg from "./img/book-svg.svg";
...
const Footer = () => {
    ...
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content grid grid-cols-1 " >
            <div>
                ...
                <img className='w-24 h-24 ml-16' src={svg} alt="SVG as an image" />

                <p>PATHAGAR<br />Copyright © 2022 - All right reserved</p>
            </div>
            <div>
